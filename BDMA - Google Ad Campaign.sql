...
CREATE DATABASE ig14_AdCampaignDB;
USE ig14_AdCampaignDB;
...
WHERE table_schema = 'ig14_AdCampaignDB';
...
-- Applying 1NF and 2NF Normalization to Database Schema
...
drop table Ad, adgroup, adgroupkeyword, adplacement, adplacementtracking,  audience, budgetallocation, campaign, campaignaudience, keyword, performancemetrics, audiencecriteria, keywordmatchtype;
